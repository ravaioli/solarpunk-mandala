...
```mermaid
flowchart TD
    subgraph OldState[Game A State Logic]
        OS1[Structural Violence]
        OS2[Official Secrecy & Denial]
        OS3[Impunity & Fragmented Trauma]
    end

    OS3 --> A

    subgraph RitualProcess[The Tribunal as Ritual]
        A[“Public, Authoritative<br>Adjudication”] --> B[“Confrontation with<br>Evidence & Testimony”]
        B --> C[“Creation of a<br>Shared Historical Record”]
        B --> D[“Catharsis & Vindication<br>for Victims”]
    end

    C --> E
    D --> E

    subgraph NewCommonwealth[Outcomes for Game B Foundation]
        E[“Collective Mandate of<br>'Never Again'”]
        F[“Legitimacy Transfer:<br>From Old State to People”]
        G[“'Negative Constitution':<br>Prohibitions Informing First Laws”]
    end
...
| :--- | :--- | :--- | :--- |
| **Legal & Statutory** | **Section 287(g) of the INA:** Delegates federal immigration enforcement authority to state/local law enforcement, creating a legal gray zone [citation:4].<br>**Qualified Immunity:** Protects individual officers from civil liability for constitutional violations.<br>**Opaque Budgeting:** DHS/ICE budgets with classified or fungible allocations for enforcement operations. | Congress (crafting laws), The Judiciary (upholding immunity), DHS bureaucracy. | Public litigation challenging specific MOAs; legislative campaigns to repeal 287(g); whistleblowers exposing budget misuse. |
| **Political & Operational** | **Executive Order 14159 (2025):** Mandates ICE to expand 287(g) agreements "to the maximum extent permitted by law," creating top-down political pressure [citation:4].<br>**Memorandums of Agreement (MOAs):** Bilateral contracts that formalize partnerships, often negotiated without public oversight. | The Executive Branch, Governors & Mayors, Police Unions, For-profit detention lobbyists. | Local/State "Sanctuary" policies refusing cooperation; investigative journalism on MOA terms; electoral challenges to pro-287(g) officials. |
| **Cultural & Narrative** | **"Force Multiplier" Framing:** Portrays the program as essential for "safety and security," embedding it in public safety discourse [citation:4].<br>**Criminalization Narrative:** Targets "criminal aliens," deflecting criticism from systemic abuse to individual culpability. | Agency Public Affairs, aligned media outlets, political figures. | Counter-narratives from affected communities; data exposing non-criminal targets; framing abuse as a "moral crisis." |

```mermaid
flowchart TD
    A[Architecture of Impunity<br>ICE Enforcement Program] --> B
    
    subgraph B[Legal & Statutory Shield]
        B1[Section 287g Authority<br>Delegates Enforcement]
        B2[Qualified Immunity<br>Protects Officers]
        B3[Opaque Agency Budgets]
    end
    
    A --> C
    subgraph C[Political & Operational Shield]
        C1[Executive Order Mandates<br>Program Expansion]
        C2[Confidential MOAs<br>Avoid Public Oversight]
        C3[For-Profit Prison<br>Industry Lobbying]
    end
    
    A --> D
    subgraph D[Cultural & Narrative Shield]
        D1[Force Multiplier Framing<br>Public Safety Narrative]
        D2[Criminal Alien Rhetoric<br>Deflection Strategy]
    end
    
    B --> E[Enabling Actors 1<br>Congress, Judiciary]
    C --> F[Enabling Actors 2<br>Executive, Local Officials]
    D --> G[Enabling Actors 3<br>Agency PR, Media]
    
    E --> H
    F --> H
    G --> H
    
    subgraph H[Points of Vulnerability]
        H1[Litigation Strategies<br>Legislative Repeal]
        H2[Whistleblower Networks<br>Sanctuary Policies]
        H3[Counter-Narrative Campaigns<br>Data Journalism]
    end
```
...
```mermaid
flowchart TD
    A[“Source of Authority<br>Will of the People / Popular Assemblies”] --> B

    subgraph B[Tribunal Structure]
        B1[“Judges of Conscience<br>Historians, Jurists, Elders”]
        B2[“Prosecutorial Commission<br>Investigators & Community Advocates”]
        B3[“Victims' & People's Advocates”]
    end

    B2 --> C
    subgraph C[Procedural Flow]
        C1[“Phase 1: Indictment<br>Public Presentation of Charges”]
        C2[“Phase 2: Evidentiary Hearing<br>Documents, OSINT, Expert Testimony”]
        C3[“Phase 3: Victim Impact<br>Public Testimony & Narrative”]
        C4[“Phase 4: Deliberation & Judgment<br>Moral Condemnation & Findings of Fact”]
    end

    C4 --> D
    subgraph D[Non-Carceral Outcomes & Sentences]
        D1[“Public Declaration of Guilt<br>Permanent Historical Record”]
        D2[“Disqualification from<br>Future Public Office”]
        D3[“Mandated Reparations Program<br>To be enacted by Commonwealth”]
    end

    D1 --> E[“Lays Ethical Groundwork &<br>'Negative Constitution' for Commonwealth”]
```
...
```mermaid
flowchart LR
    A[“Module 1:<br>Guerrilla Archiving”] --> A1[“Automated Web Scraping<br>Physical Document Rescue”]
    A1 --> A2[“Distributed &<br>Encrypted Storage”]

    B[“Module 2:<br>Protected Witness Networks”] --> B1[“Secure Comms<br>Safe Houses / Relocation”]
    B1 --> B2[“Pre-emptive Legal<br>& Psychological Support”]

    C[“Module 3:<br>OSINT & Counter-Forensics”] --> C1[“Financial &<br>Geospatial Analysis”]
    C1 --> C2[“Social Network<br>Mapping”]

    A2 --> D[“Module 4:<br>Verification & Registry”]
    B2 --> D
    C2 --> D

    D --> D1[“Cryptographic Hashing<br>Chain-of-Custody Logs”]
    D1 --> D2[“Central Evidence Registry<br>Secure & Indexed”]
    D2 --> E[“Compiled Dossier for<br>Tribunal Indictment”]
```
...
```mermaid
flowchart LR
    subgraph Phase1[Phase 1: Forensic Mapping]
        P1A[“Diagnose the 'Shield'<br>Legal, Political, Cultural Layers”]
        P1B[“Identify Points of<br>Vulnerability & Key Actors”]
    end

    subgraph Phase2[Phase 2: Institution Building]
        P2A[“Draft Tribunal Charter<br>Source of Authority & Jurisdiction”]
        P2B[“Build Investigative Capacity<br>Archiving, Witness Protection, OSINT”]
    end

    subgraph Phase3[Phase 3: Execution & Ritual]
        P3A[“Bring Indictment &<br>Conduct Public Hearings”]
        P3B[“Facilitate Victim Testimony &<br>Establish Authoritative Record”]
    end

    subgraph Phase4[Phase 4: Foundation Laying]
        P4A[“Issue Moral Condemnation &<br>Non-Carceral Sentences”]
        P4B[“Transfer Legitimacy &<br>Define 'Negative Constitution'”]
    end

    Phase1 --> Phase2 --> Phase3 --> Phase4

    P4B --> NewStart[“Ethical Groundwork for the<br>Symbiotic Commonwealth”]
```
