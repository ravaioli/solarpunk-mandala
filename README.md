...
```mermaid
graph TD
    A["📁 Solarpunk Mandala"] --> B["👥 Community"]
    A --> C["🏛️ Framework"]
    A --> D["📚 Knowledge Base"]
    A --> E["🛠️ Tools"]
    A --> F["📄 Docs"]
...
**Citation**: 
Bajnath, Ravi. (2025). *Solarpunk Mandala: A Unified Framework for Conscious Regeneration*. GitHub Repository. https://github.com/ravaioli/solarpunk-mandala
