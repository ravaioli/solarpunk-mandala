...
```mermaid
flowchart TD
    A[Consciousness<br>Mind at Large] --> B[Dissociation Boundary]
    B --> C[Individual Alter<br>The Self]
    B --> D[Food as Pattern of Consciousness<br>The Other]
    
    C -- “Pathology of the Boundary” --> E[Disordered Eating<br>Metabolic Disease<br>Ecological Disconnection]
    D -- “Processed, Industrialized” --> E
    
    F[Culinary Medicine Protocol] --> G{Conscious<br>Ingestion}
    C --> G
    D -- “Whole, Regenerative” --> G
    G --> H[Reintegration & Healing<br>Self + Other → Nourished Whole]
```
...
```mermaid
flowchart LR
    A[The Meal<br>Prebiotics / Probiotics / Fats] --> B[Gut & Microbiome]
    B -- Vagus Nerve<br>Signaling & Immune Pathways --> C[The Brain]
    
    subgraph B [Gut & Microbiome]
        B1[Neurotransmitter<br>Production Serotonin, GABA]
        B2[Inflammation<br>Modulation]
        B3[Gut Barrier<br>Integrity “Leaky Gut”]
    end

    subgraph C [The Brain]
        direction TB
        C1[Stress Response]
        C2[Mood & Cognition]
        C3[Systemic Homeostasis]
    end
    
    C -- “Behavior & Food Choices” --> A
```
...
```mermaid
flowchart TD
    CM[Culinary Medicine<br>The Central Synthesizing Practice]
    ...
    subgraph Soteriological[<b>Soteriological Axis</b><br>Healing the Self]
        direction LR
        S1[Mindful Eating]
        S2[Food-Boundary Mapping]
        S3[Intuitive Cooking]
    end
    
    subgraph Relational[<b>Relational Depth Axis</b><br>Healing the 'Us']
        direction LR
        R1[Community Kitchens]
        R2[Ritual Meal Formats]
        R3[Shared Food Labor]
    end
    
    subgraph Axiological[<b>Axiological Axis</b><br>Healing the 'All Life']
        direction LR
        A1[Regenerative Sourcing]
        A2[Zero-Waste Cycles]
        A3[Multispecies Kinship]
    end
    
    subgraph Temporal[<b>Temporal Orientation Axis</b><br>Healing Through Time]
        direction LR
        T1[Seasonal & Cyclical Eating]
        T2[Preservation Techniques]
        T3[Ancestral Recipe Revival]
    end
