...
```mermaid
flowchart TD
    START([Protocol Initiation]) --> TRIGGER{Activation Trigger?}
    
    TRIGGER -->|Project Start| GATECHECK[Gate Check<br/>Threshold Verification]
    TRIGGER -->|Crisis Event| EMERGENCY[Emergency Assessment<br/>5-min Check]
    TRIGGER -->|Routine Schedule| SCHEDULED[Scheduled Assessment<br/>Full/Partial]
    
    GATECHECK --> THRESHOLD{Any foundation <2.0?}
    EMERGENCY --> CRITICAL{Any foundation <1.5?}
    
    THRESHOLD -->|Yes| PROTOCOL3[Activate Protocol 3<br/>Crisis Response]
    THRESHOLD -->|No| CONTINUE[Continue Full Assessment]
    
    CRITICAL -->|Yes| IMMEDIATE[Immediate Emergency Response<br/>Pause All Other Work]
    CRITICAL -->|No| CONTINUE2[Continue Rapid Assessment]
    
    PROTOCOL3 --> STABILIZE[Foundation Stabilization<br/>Daily Monitoring]
    IMMEDIATE --> STABILIZE
    
    CONTINUE --> ASSESS[Core Assessment Matrix]
    CONTINUE2 --> ASSESS
    
    ASSESS --> SCORE{Overall Foundation Score?}
    
    SCORE -->|1.0-1.9| EMERGPHASE[Emergency Phase<br/>Daily Actions]
    SCORE -->|2.0-2.9| FRAGILE[Fragile Phase<br/>Weekly Actions]
    SCORE -->|3.0-3.9| STABLE[Stable Phase<br/>Monthly Actions]
    SCORE -->|4.0-5.0| REGEN[Regenerative Phase<br/>Quarterly Integration]
    
    EMERGPHASE --> ACTIONS1[1. Immediate Resource Allocation<br/>2. External Support<br/>3. Simplify Everything]
    FRAGILE --> ACTIONS2[1. Buffer Creation<br/>2. Skill Sharing<br/>3. Corrective Plans]
    STABLE --> ACTIONS3[1. Incremental Improvement<br/>2. System Integration<br/>3. Redundancy]
    REGEN --> ACTIONS4[1. Surplus Sharing<br/>2. Mentorship<br/>3. Innovation]
    
    ACTIONS1 --> FOLLOWUP[Schedule Follow-up<br/>1-7 days based on severity]
    ACTIONS2 --> FOLLOWUP2[Schedule Follow-up<br/>2-4 weeks]
    ACTIONS3 --> FOLLOWUP3[Schedule Follow-up<br/>1-3 months]
    ACTIONS4 --> FOLLOWUP4[Schedule Follow-up<br/>3-6 months]
    
    style START fill:#bbdefb
    style EMERGENCY fill:#ffcdd2
    style PROTOCOL3 fill:#ffcdd2
    style IMMEDIATE fill:#ffcdd2
    style EMERGPHASE fill:#ffebee
    style FRAGILE fill:#fff3e0
...
|-------------|-------------------|-------------------------|------------------|
| **1.0-1.9** | Emergency Collapse | Foundational systems failing or absent. Survival threatened. | 1. Immediate Protocol 3 activation<br>2. Focus resources on single most critical foundation<br>3. Daily monitoring<br>4. External support mobilization |
| **2.0-2.9** | Fragile Stability | Basic needs met but unreliable. High vulnerability to disruption. | 1. Simplified protocol monthly<br>2. Corrective action plan within 48h<br>3. Buffer creation for critical resources<br>4. Community skill-sharing for foundation care |
| **3.0-3.9** | Stable Foundation | Reliable systems supporting most members. Capacity for basic regeneration. | 1. Standard protocol quarterly<br>2. Incremental improvements toward 4.0<br>3. Begin integrating foundations with other protocols<br>4. Develop redundancy systems |
| **4.0-4.9** | Regenerative Flow | Systems enhance community and ecological vitality. Creating surplus value. | 1. Comprehensive protocol biannually<br>2. Share surplus with neighboring communities<br>3. Mentor other communities<br>4. Innovate new foundation practices |
| **5.0** | Transformative Integration | Foundations become generative portals for consciousness evolution. | 1. Protocol fully integrated into community being<br>2. Foundations teach other communities<br>3. Contribute to framework evolution<br>4. Create art/ritual expressing foundation wisdom |
...
```mermaid
graph TD
    subgraph "Embodied Foundations Core"
        CORE[Foundation Core<br/>Community Vitality]
    end
    
    subgraph "Primary Foundation Domains"
        NOUR[Nourishment<br/>Food/Water Systems]
        CLEAN[Cleansing<br/>Waste/Emotional Processing]
        REST[Restoration<br/>Sleep/Trauma Healing]
        MOVE[Movement<br/>Access/Flow/Transition]
    end
    
    subgraph "Supporting Contexts"
        CARE[Community Care<br/>Mutual Support Networks]
        CYCLES[Natural Cycles<br/>Seasonal/Temporal Patterns]
    end
    ...
    NOUR -.->|Strong Connection| CLEAN
    CLEAN -.->|Strong Connection| REST
    REST -.->|Strong Connection| MOVE
    MOVE -.->|Strong Connection| NOUR
    
    NOUR -.-|Weak Connection| CYCLES
    CLEAN -.-|Weak Connection| CARE
    REST -.-|Developing Connection| CYCLES
    
    style CORE fill:#e1f5e1,stroke:#2e7d32,stroke-width:3px
    style NOUR fill:#fff3e0,stroke:#ef6c00
    style CLEAN fill:#e3f2fd,stroke:#1565c0
    style REST fill:#f3e5f5,stroke:#7b1fa2
    style MOVE fill:#e8f5e9,stroke:#388e3c
    style CARE fill:#fff8e1,stroke:#f9a825
    style CYCLES fill:#e0f7fa,stroke:#00838f
```
...
graph TB
    subgraph "Foundation Layer"
        P0[<b>Protocol 0</b><br/>Embodied Foundations Audit]
    end
    
    subgraph "Stability Layer"
        P1[Protocol 1<br/>Settlement Health]
        P3[Protocol 3<br/>Crisis Response]
    end
    
    subgraph "Development Layer"
        P2[Protocol 2<br/>Project Design]
    end
    
    subgraph "Regeneration Layer"
        P4[Protocol 4<br/>Governance Design]
        P5[Protocol 5<br/>Cultural Evolution]
    end
    
    P0 -->|Requires ≥2.5| P1
    P0 -->|Triggers if <2.0| P3
    P0 -->|Requires ≥3.0| P2
    P0 -->|Requires ≥3.5| P4
    P0 -->|Requires ≥4.0| P5
    
    P3 -.->|Restores foundations| P0
    P1 -.->|Monitors foundations| P0
    P2 -.->|Maintains foundations| P0
    P4 -.->|Governs foundations| P0
    P5 -.->|Celebrates foundations| P0
    
    P1 --> P2
    P2 --> P4
    P4 --> P5
    
    style P0 fill:#e1f5e1,stroke:#2e7d32,stroke-width:3px
