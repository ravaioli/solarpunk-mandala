...
flowchart TD
    subgraph "Diagnostic Inputs"
        P0[Protocol 0<br/>Embodied Foundations]
        CONTEXT[Community Context<br/>History, Bioregion, Scale]
    end

    P0 -->|Provides Stability For| P1
    CONTEXT -->|Informs Interpretation of| P1

    subgraph "P1: Core Assessment Matrix"
        direction LR
        SOT[Soteriological Axis<br/>Self-Integration / UL Boundary]
        AXI[Axiological Axis<br/>System Regeneration / UR Boundary]
        REL[Relational Axis<br/>Connection Quality / LL Boundary]
        TEM[Temporal Axis<br/>Time Wisdom / LR Boundary]
    end

    P1 -->|Generates Data For| SCORE[Scoring Synthesis<br/>& Health Diagnosis]
    
    SCORE -->|Feeds Into| DECISION{Strategic Pathway Decision}
    
    DECISION -->|Scores 1.0-1.9| P3[Activate Protocol 3<br/>Crisis Stabilization]
    DECISION -->|Scores 2.0-2.9| P2[Activate Protocol 2<br/>Targeted Project Design]
    DECISION -->|Scores 3.0-3.9| OPT[Optimize & Integrate<br/>Strengthen Connections]
    DECISION -->|Scores 4.0-5.0| EVOL[Evolve & Mentor<br/>Share Surplus, Innovate]

    SOT <-.->|Influences & Is Influenced By| AXI
    AXI <-.->|Influences & Is Influenced By| REL
    REL <-.->|Influences & Is Influenced By| TEM
    TEM <-.->|Influences & Is Influenced By| SOT
...
```mermaid
flowchart TD
    N[NATURE<br/>Environment, Resources]
    H[HUMAN<br/>Individual, Consciousness]
    SO[SOCIETY<br/>Community, Collective]
    SH[SHELLS<br/>Buildings, Infrastructure]
    NEO[NETWORKS<br/>Systems, Connections]
    C[CULTURE<br/>Meaning, Ritual, Story]

    N -- "NATURE⇢HUMAN<br/>Access & Health" --> H
    H -- "HUMAN⇢SOCIETY<br/>Agency & Rights" --> SO
    SO -- "SOCIETY⇢SHELLS<br/>Needs Shape Form" --> SH
    SH -- "SHELLS⇢NETWORKS<br/>Form Enables Flow" --> NEO
    NEO -- "NETWORKS⇢CULTURE<br/>Flow Carries Meaning" --> C
    C -- "CULTURE⇢NATURE<br/>Meaning Shapes Care" --> N

    N -- "NATURE⇢SOCIETY<br/>Ecology of Community" --- SO
    H -- "HUMAN⇢SHELLS<br/>Embodiment & Shelter" --- SH
    SO -- "SOCIETY⇢NETWORKS<br/>Social Structures" --- NEO
    SH -- "SHELLS⇢CULTURE<br/>Sacred Space" --- C
    NEO -- "NETWORKS⇢NATURE<br/>Cybernetic Loops" --- N
    C -- "CULTURE⇢HUMAN<br/>Worldview & Identity" --- H

    style N fill:#c8e6c9
    style H fill:#bbdefb
    style SO fill:#fff9c4
    style SH fill:#ffccbc
    style NEO fill:#d1c4e9
    style C fill:#f8bbd0
```
...
```mermaid
flowchart TD
    START([Start Community Work]) --> P0[Complete Protocol 0<br/>Embodied Foundations Audit]
    
    P0 --> CHECK{P0 All Foundations ≥2.0?}
    CHECK -->|No| STABILIZE[Return to P0/P3<br/>Stabilize Foundations]
    CHECK -->|Yes| P1[Proceed to Protocol 1<br/>Settlement Health Assessment]
    
    P1 --> DIAGNOSE[Produce Health Diagnosis<br/>& Identify Priority Interfaces]
    
    DIAGNOSE --> REVIEW{Review Composite Score<br/>& Dialectical Velocity}
    
    REVIEW -->|Score 1.0-1.9<br/>or Velocity <0.2| CRISIS[CRISIS PATH<br/>Activate Protocol 3<br/>Focus on Critical Axis]
    REVIEW -->|Score 2.0-3.9| DEVELOPMENT[DEVELOPMENT PATH<br/>Activate Protocol 2<br/>Design Targeted Projects]
    REVIEW -->|Score 4.0-5.0| REGENERATE[REGENERATION PATH<br/>Proceed to Protocols 4/5<br/>Evolve Governance & Culture]
    
    CRISIS --> STABILIZED{Foundations &<br/>Critical Axis Stabilized?}
    STABILIZED -->|Yes| DEVELOPMENT
    STABILIZED -->|No| CRISIS
    
    DEVELOPMENT --> PROJECTS[Execute Protocol 2 Projects]
    PROJECTS --> REASSESS{3-6 Month Cycle}<-->|Re-assess with P1| P1
    
    REGENERATE --> EVOLVE[Evolve Governance P4<br/>& Culture P5]
    EVOLVE --> SHARE[Mentor Other Communities<br/>Contribute to Framework]
    
    style START fill:#e3f2fd
    style P0 fill:#e1f5e1
    style CRISIS fill:#ffebee
    style DEVELOPMENT fill:#fff3e0
    style REGENERATE fill:#e8f5e9
```
